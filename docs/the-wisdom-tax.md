---
title: "The Wisdom Tax — Evan Sims"
...
1. **Pre-mortem.** Before you start, imagine the project failed and write out why. The reasons you generate are usually the actual risks.
2. **Inversion.** Instead of asking "How do I succeed?", ask "What would cause me to fail?" Then avoid those things.
3. **Second-order thinking.** Most people consider only the immediate effects of their choices. Ask "and then what?" twice more.
4. **The 72-hour rule.** For any important decision, give yourself three days before committing. The space between impulse and action is where wisdom lives.
